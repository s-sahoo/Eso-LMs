...
RUN_NAME=sudoku-esolmb-alpha0-1-finetune-${SLURM_JOB_ID}
...
srun python -u -m main \
  ...
  training.finetune_path=/share/thickstun/zhihan/checkpoints/esolm/sudoku-esolmb-alpha0-1-286555/checkpoints/best.ckpt \
  optim.lr=3e-5 \
